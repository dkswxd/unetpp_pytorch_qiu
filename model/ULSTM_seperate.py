...
class ULSTM_seperate(nn.Module):
    def __init__(self, layers, input_channel, num_filter, conv_repeat, use_deform):
        super().__init__()
        self.ublock = _UBlock(layers, input_channel, num_filter, conv_repeat, use_deform)

        self._conv = nn.Conv2d(in_channels=num_filter + num_filter,
